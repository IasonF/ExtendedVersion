...
\bibitem{Ang13b}
Kritikakou A, et~al (2013{\natexlab{a}}) Near-optimal and scalable intra-signal
...
\bibitem{Ang13}
Kritikakou A, et~al (2013{\natexlab{b}}) A scalable and near-optimal
...
\bibitem{Pal06}
Palkovic M, Catthoor F, Corporaal H (2006{\natexlab{a}}) Dealing with variable
...
Palkovic M, Corporaal H, Catthoor F (2007) Heuristics for scenario creation to
  ...
  on, pp 1 --4, \doi{10.1109/ISSOC.2007.4427430}

\bibitem{Pal06b}
Palkovic M, et~al (2006{\natexlab{b}}) Systematic preprocessing of data
...
Simunic T, et~al (1999) Cycle-accurate simulation of energy consumption in
  ...
  1999., pp 867 --872, \doi{10.1109/DAC.1999.782199}
