...
\begin{figure}[!t]
\centering
\includegraphics[width=0.45\textwidth]{profiling.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.40\textwidth]{clustering.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.45\textwidth]{runtime.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{platform.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{6apps.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{6appsGains.eps}
