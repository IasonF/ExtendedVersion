...
\title{Exploration of energy efficient memory organisations for dynamic media applications using system scenarios}

% a short form should be given in case it is too long for the running head
\titlerunning{System scenarios on memory organisation}

\author{Iason Filippopoulos$ ^{1} $\and Francky Catthoor$ ^{2} $
\and Per Gunnar Kjeldsberg$ ^{1} $}
%
\authorrunning{System scenarios on memory organisation}
% (feature abused for this document to repeat the title also on left hand pages)

\institute{$ ^{1} $ NTNU, Trondheim, Norway\\
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{profiling_v2.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{clust1.eps}
...
The memory energy consumption per read access is given by Equation ~\ref{eq:energy}, which is provided by the memory models in \cite{Artes2011}.    
\begin{multline}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.4in]{eegprof.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{results1.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{res2.eps}
